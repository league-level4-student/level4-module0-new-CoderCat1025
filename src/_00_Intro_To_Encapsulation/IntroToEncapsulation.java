...
System.out.println(car.getColor() + car.getFuelInTank() + car.getFuelTankCapacity() + car.getMpg());
...
class Vehicle {
	...
	public void setMpg(int mpg) {
		this.mpg = mpg;
		this.fuelInTank = getFuelInTank();
		this.color = getColor();
		this.fuelTankCapacity = getFuelTankCapacity();
	}
